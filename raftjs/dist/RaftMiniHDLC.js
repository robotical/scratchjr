...
var RaftMiniHDLCState;
(function (RaftMiniHDLCState) {
    RaftMiniHDLCState[RaftMiniHDLCState["STATE_ESCAPE"] = 0] = "STATE_ESCAPE";
    RaftMiniHDLCState[RaftMiniHDLCState["STATE_READ"] = 1] = "STATE_READ";
})(RaftMiniHDLCState || (RaftMiniHDLCState = {}));
const CRC_LUT = [
    0x0000,
    0x1021,
    0x2042,
        ...
        if (rxByte === this.FRAME_BOUNDARY_OCTET) {
            if (this.rxBuffer.length > 2) {
                ...
                if (this._checkCRC()) {
                    ...
                    if (frameElapsedMs > 0) {
                        RaftLog_1.default.verbose('RaftMiniHDLC::frameRx ' + this.rxBuffer.length +
...
exports.default = RaftMiniHDLC;
//# sourceMappingURL=RaftMiniHDLC.js.map