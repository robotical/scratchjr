...
<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 66">
  ...
  <g>
    ...
    <g>
      <circle id="circle--2" class="cls-2" cx="47.83" cy="27.44" r="2.48" fill="${lights[0]}"/>
    ...
    <g>
      <circle id="circle--3" class="cls-2" cx="28.37" cy="38.75" r="2.48" fill="${lights[1]}"/>
    ...
    <g>
      <circle id="circle--4" class="cls-2" cx="32.44" cy="23.37" r="2.48" fill="${lights[2]}"/>
    ...
    <g>
      <circle id="circle--5" class="cls-2" cx="43.75" cy="42.82" r="2.48" fill="${lights[3]}"/>
    ...
    <g>
      <circle id="circle--6" class="cls-2" cx="28.46" cy="27.46" r="2.48" fill="${lights[4]}"/>
    ...
    <g>
      <circle id="circle--7" class="cls-2" cx="26.99" cy="33.14" r="2.48" fill="${lights[5]}"/>
    ...
    <g>
      <circle id="circle--8" class="cls-2" cx="37.89" cy="21.81" r="2.48" fill="${lights[6]}"/>
    ...
    <g>
      <circle id="circle--" class="cls-2" cx="43.85" cy="23.34" r="2.48" fill="${lights[7]}"/>
    ...
    <g>
      <circle id="circle--9" class="cls-2" cx="47.77" cy="38.8" r="2.48" fill="${lights[8]}"/>
    ...
    <g>
      <circle id="circle--10" class="cls-2" cx="49.23" cy="33.21" r="2.48" fill="${lights[9]}"/>
    ...
    <g>
      <circle id="circle--11" class="cls-2" cx="32.51" cy="42.93" r="2.48" fill="${lights[10]}"/>
    ...
    <g>
      <circle id="circle--12" class="cls-2" cx="38.27" cy="44.32" r="2.48" fill="${lights[11]}"/>
